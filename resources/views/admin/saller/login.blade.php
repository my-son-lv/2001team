...
<head>
	...
	<title>商家后台，欢迎登陆</title>
	 <link rel="icon" href="assets/img/favicon.ico">

    <link rel="stylesheet" type="text/css" href="/status/css/webbase.css" />
    <link rel="stylesheet" type="text/css" href="/status/css/pages-shoplogin.css" />
</head>
						...
						<div id="profile" class="tab-pane  active">
							<form class="sui-form">
								<div class="input-prepend"><span class="add-on loginname"></span>
									<input id="prependedInput" type="text" name="username" placeholder="请输入商家账号" class="span2 input-xfat">
								</div>
								<div class="input-prepend"><span class="add-on loginpwd"></span>
									<input id="prependedInput" type="password" name="password" placeholder="请输入商家密码" class="span2 input-xfat">
								</div>
								<div class="setting">
								...
								<div class="logined">
									<a class="sui-btn btn-block btn-xlarge btn-danger logindo" href="javascript:void(0)">登&nbsp;&nbsp;录</a>
								</div>
							</form>
							<div class="otherlogin">
								<div class="types">
									<ul>
										<li><img src="/status/img/qq.png" width="35px" height="35px" /></li>
										<li><img src="/status/img/sina.png" /></li>
										<li><img src="/status/img/ali.png" /></li>
...
<script type="text/javascript" src="/status/js/pages/shoplogin.js"></script>
</body>
...
<script>
	$(document).on('click','.logindo',function(){
		...
		if(username==""){
			alert('商家账号不能为空');return ;
		}
		if(password==""){
			alert('商家密码不能为空');return ;
		}
		$.ajax({
			url:"/saller/logindo",
			type:'post',
...
//				 console.log(res);
				if(res.code=='0000'){
					alert(res.msg);
					window.location.href = "{{url('/saller')}}";
				}else{
					alert(res.msg);
				}
			}
