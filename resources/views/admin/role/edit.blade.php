                            ...
                            <div class="tab-pane active" id="home">
                                <div class="row data-type">                                  
                                    ...
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" value="{{$data->role_name}}" name="role_name" ng-model="entity.name"  placeholder="角色名称" value="">
                                    </div>
									
                                    <div class="col-md-2 title">角色内容</div>
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" value="{{$data->role_desc}}" name="role_desc" ng-model="entity.telephone"  placeholder="角色内容" value="">
                                    </div>
