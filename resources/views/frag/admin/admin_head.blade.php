...
<header class="main-header">
    ...
    <a href="/admin" class="logo">
        ...
        <span class="logo-lg"><b>根哥麻辣烫-食品运营</b></span>
    </a>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="/status/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                            团队消息
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="/status/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                            Developers
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="/status/img/user2-160x160.jpg" class="user-image" alt="User Image">
